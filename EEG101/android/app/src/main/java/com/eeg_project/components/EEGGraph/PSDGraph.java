...
public class PSDGraph extends FrameLayout {
    ...
    public void initView(Context context) {
        ...
        // Set X and Y domain
        psdPlot.setRangeBoundaries(-30, -15, BoundaryMode.FIXED);
        psdPlot.setDomainBoundaries(0, PLOT_LENGTH, BoundaryMode.AUTO);
            ...
            try {
                ...
                while (keepRunning) {
                    ...
                    if (eegFresh) {
                        ...
                        Log.w("PSD", Arrays.toString(logpower[0]));
