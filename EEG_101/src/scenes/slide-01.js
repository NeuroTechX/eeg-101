...
function  mapStateToProps(state) {
    return {isVisible: state.scene.sceneKey === 'SlideOne'};
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <ViewPagerAndroid //Allows us to swipe between blocks
          ...
          <View style={styles.pageStyle}>
            ...
            <Text style={styles.body}>
              Using the <PopUpLink onPress={() => this.setState({popUp1Visible: true})}>EEG </PopUpLink>
              device that you are wearing, we can detect the electrical activity of your brain.
            </Text>
          </View>
          ...
          <View style={styles.pageStyle}>
            ...
            Eye movements create
             <PopUpLink onPress={() => this.setState({popUp2Visible: true})}> noise </PopUpLink>
              in the EEG signal.
            </Text>
          </View>
          ...
          <View style={styles.pageStyle}>
            ...
            <Text style={styles.body}>Although EEG can measure overall brain activity, it’s not capable of 
             <PopUpLink onPress={() => this.setState({popUp3Visible: true})}> reading minds.</PopUpLink>
            </Text>
          </View>

          <View style={styles.pageStyle}>
            <Text style={styles.header}>Now try closing your eyes for 10 seconds</Text>
            <Text style={styles.body}>You may notice a change in your signal due to an increase in 
            <PopUpLink onPress={() => this.setState({popUp4Visible: true})}> alpha waves.</PopUpLink>
            </Text>
        ...
        <PopUp onClose={() => this.setState({popUp1Visible: false})} visible={this.state.popUp1Visible}>
          <Image source={require('../assets/hansberger.jpg')} resizeMode='contain'
