...
function  mapStateToProps(state) {
    return {isVisible: state.scene.sceneKey === 'SlideThree'};
  }
      ...
      <View style={styles.container}>
        ...
        <ViewPagerAndroid //Allows us to swipe between blocks
          ...
          <View style={styles.pageStyle}>
            ...
            <Text style={styles.body}>The electrical activity of the brain is sensed by 
             <PopUpLink onPress={() => this.setState({popUp1Visible: true})}> electrodes </PopUpLink>
             placed on the scalp.
            </Text>
          </View>
          ...
          <View style={styles.pageStyle}>
            ...
            <Text style={styles.body}>The device you are wearing has
             <PopUpLink onPress={() => this.setState({popUp2Visible: true})}> 4 seperate electrodes</PopUpLink>
             . Touch the head diagram above to view the signal at each of the electrodes.
            </Text>
          </View>
        ...
        <Image source={require('../assets/electrodelocations.png')} resizeMode='contain'
